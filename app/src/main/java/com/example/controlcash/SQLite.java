...
public class SQLite extends SQLiteOpenHelper {
    ...
    private static final int DATABASE_VERSION = 4; // actualizado para incluir campo usuario en compras
    ...
    public static final String COLUMN_USUARIO = "usuario"; // nuevo campo
    ...
    public boolean insertarCompra(String nombre, double precio, int cantidad, double subtotal, double descuento, double total, double latitud, double longitud, String usuario) {
        ...
        values.put(COLUMN_USUARIO, usuario); // guardar usuario
