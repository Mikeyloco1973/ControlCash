...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView tvAhorros, tvSubtotal, tvTotal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnAgregarCompra).setOnClickListener(v -> {
            startActivity(new Intent(MainActivity.this, AgregarCompraActivity.class));
        });
